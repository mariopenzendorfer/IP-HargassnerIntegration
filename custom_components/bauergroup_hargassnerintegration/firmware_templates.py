...
PARAMETER_DESCRIPTIONS: Final[dict[str, dict[str, str]]] = {
    ...
    "Stoerungs Nr": {"en": "Error Code", "de": "Störungsnummer"},  # V14_0HAR_q ASCII variant
